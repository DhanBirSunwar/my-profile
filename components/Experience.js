function Experience() {
    return (
        <div className="flex justify-center border-t-2 border-gray-100 py-16">
            <div className="ml-20">
                <p className="text-[32px] font-bold text-center"> What I’m good at?</p>
                ...
                <div className="grid grid-cols-2 gap-4 mt-16">
                    <div className="bg-gray-200 p-12">
                        ...
                        <p className="text-[26px] font-bold py-8">HTML5 & CSS3</p>
                        <p>Phasellus non convallis dolor. Integer tempor hendrerit arcu at bibendum. Sed ac ante non
                            metus vehicula congue quis eget eros.</p>
                    </div>
                    <div className="bg-gray-200 p-12">
                        <svg xmlns="http://www.w3.org/2000/svg" height="70" width="70">
                            <path
                        ...
                        <p className="text-[26px] font-bold py-8">Creative Ideas</p>
                        <p>Phasellus non convallis dolor. Integer tempor hendrerit arcu at bibendum. Sed ac ante non
                            metus vehicula congue quis eget eros.</p>
                    </div>
                    <div className="bg-gray-200 p-12">
                        ...
                        <p className="text-[26px] font-bold py-8">Easy Customize</p>
                        <p>Phasellus non convallis dolor. Integer tempor hendrerit arcu at bibendum. Sed ac ante non
                            metus vehicula congue quis eget eros.</p>
                    </div>
                    <div className="bg-gray-200 p-12">
                        ...
                        <p className="text-[26px] font-bold py-8">Admin Dashboard</p>
                        <p>Phasellus non convallis dolor. Integer tempor hendrerit arcu at bibendum. Sed ac ante non
                            metus vehicula congue quis eget eros.</p>
                    </div>
                </div>
